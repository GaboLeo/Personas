<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.master" AutoEventWireup="true"
    CodeFile="RecuperaWebService.aspx.cs" Inherits="PruebaGV" %>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div style="overflow: scroll; height: 300px;">
                    ...
                    <br />
                    <br />
                    <asp:TextBox ID="txt" placeholder="Introduce Id" runat="server"></asp:TextBox>
                    <asp:Button ID="btn" Text="Colocar" runat="server" onclick="btn_Click" />
                </div>
            </div>
        </div>
    </div>
